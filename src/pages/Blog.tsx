      ...
      <section className="py-12 md:py-20">
        <div className="container max-w-6xl px-4">
          ...
          <div className="grid gap-6 md:gap-8">
            <Card className="hover:shadow-2xl transition-all duration-300 bg-white border-2 border-gray-200">
                  ...
                  <div className="flex items-start gap-3 md:gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2 mb-2">
                        <span className="text-xs md:text-sm text-gray-500">15 января 2025</span>
                      ...
                      <CardTitle className="text-lg md:text-2xl lg:text-3xl mb-2 md:mb-3 break-words">
                        Скоро здесь появится первая статья
                      </CardTitle>
                    </div>
                  </div>
                </div>
              ...
              <CardContent className="p-4 md:p-6 pt-0">
                <p className="text-sm md:text-base text-gray-700 leading-relaxed break-words mb-4">
                  Мы готовим для вас полезные материалы о SEO-продвижении, кейсы и практические советы. 
                  Следите за обновлениями!
                </p>
                <div className="flex items-center gap-2 text-sm text-gray-500">
                  <Icon name="Clock" size={16} className="flex-shrink-0" />
                  <span className="break-words">Время чтения: ~5 минут</span>
                </div>
              </CardContent>
            </Card>
          </div>
